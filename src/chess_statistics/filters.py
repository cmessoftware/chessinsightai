"""LS01-002 — skip Lichess AI engines and games shorter than 10 full moves."""
...
MIN_FULL_MOVES = 10
MIN_TOTAL_PLIES = 20  # 10 full moves (White and Black)
MIN_TOTAL_MOVES = MIN_TOTAL_PLIES  # backward-compatible name: ply threshold
...
def filter_sync_window(
    ...
    *,
    ...
    if perf_type:
        ...
        actual = normalize_perf_type(str(game.get("perf") or game.get("speed") or ""))
        if actual != wanted:
