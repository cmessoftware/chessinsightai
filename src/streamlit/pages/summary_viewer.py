...
st.title("Resumen de dataset táctico")

uploaded_file = st.file_uploader("Subí un archivo CSV táctico enriquecido", type="csv")
...
if uploaded_file:
    ...
    st.info("Esperando archivo CSV para análisis")
