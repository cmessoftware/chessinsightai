...
**Last updated:** 2026-09-24 (requirements + locked decisions §7).
...
|----|---------|------------|--------|
| **UI-101** | 1.1 | PGN paste; multi-game; username ↔ PGN headers | ✅ `/import` |
...
| **UI-502** | Nav: single **Import** entry (7.1); Coach queue/review unchanged |
...
| Priority | Scope |
|----------|--------|
| **P1** | §1 (UI-101–107), §2 (UI-201–206), UI-301, §4 (UI-404, UI-405, UI-401, UI-402), UI-501–503 |
